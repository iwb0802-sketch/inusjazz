...
const STYLE_DESCRIPTIONS: Record<string, string> = {
  "품격형": "예식 형태와 관계없이, 차분하고 격식 있는 분위기를 만드는 사회자입니다.",
  "유쾌형": "예식 형태와 관계없이, 자연스럽고 유쾌한 텐션으로 하객 반응을 살리는 사회자입니다.",
  "감성형": "예식 형태와 관계없이, 따뜻한 톤으로 신랑신부의 이야기와 부모님 감사 순서를 전달하는 사회자입니다.",
  "아나운서형": "예식 형태와 관계없이, 정확한 발성과 안정적인 톤으로 깔끔한 식순 진행에 강한 사회자입니다.",
};
