    ...
    <section className="py-10 overflow-hidden" style={{ backgroundColor: "#0a0a0a", borderTop: "1px solid rgba(212,184,150,0.12)", borderBottom: "1px solid rgba(212,184,150,0.12)" }}>
      ...
      <div className="relative">
        ...
        <style>{`
          ...
          .mc-marquee-track { display: flex; width: max-content; animation: mc-marquee 130s linear infinite; }
          .mc-marquee-track2 { display: flex; width: max-content; animation: mc-marquee2 130s linear infinite; }
