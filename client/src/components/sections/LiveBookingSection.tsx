  ...
  return (
    <section className="bg-[#0d0d0d] py-20 sm:py-28 overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="flex mb-3" style={{ animation: "liveBookingScrollLeft 100s linear infinite" }}>
          {row1.map((d, i) => (
            <DepositCard key={`r1-${i}`} d={d} />
          ))}
        </div>
        <div className="flex" style={{ animation: "liveBookingScrollRight 100s linear infinite" }}>
          {row2.map((d, i) => (
