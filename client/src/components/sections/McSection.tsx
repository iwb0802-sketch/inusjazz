...
const MCS = [
  ...
  },
  {
    ...
    tags: ["웨딩 사회 경력 10년+", "누적 진행 1000회 이상"],
    highlight: "세련되고 격조 있는 진행에 위트를 더해 완성도 높은 예식을 만드는 사회자입니다.",
  ...
  },
  {
    ...
    highlight: "밝은 에너지와 다정한 진행으로 예식의 분위기를 따뜻하게 이끄는 사회자입니다.",
  ...
  },
  {
    ...
    tier: "BEST",
    desc: "5년+ 경력",
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663604364385/szGhyZuWuLcNjQKb.webp",
    reviewKeywords: ["매력적인중저음보이스", "신뢰감있는목소리톤", "세련되고깔끔한진행", "차분하고안정적인진행", "자연스러운분위기조율", "매끄러운예식진행"],
    tags: ["웨딩 사회 경력 5년+", "누적 진행 500회 이상"],
    highlight: "매력적인 중저음 보이스와 세련된 진행으로 예식의 흐름을 안정감 있게 이끌어가는 사회자입니다.",
    profileUrl: "https://blog.naver.com/inusmusics/224418630247",
    styles: ["품격형", "아나운서형"],
    youtubeId: "RgUrMxApjPU",
    audioFile: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663604364385/cMMUGxQiWJMRRtWI.mp3",
    profileCardImg: "",
  },
];
...
const STYLE_DESCRIPTIONS: Record<string, string> = {
  "품격형": "차분하고 격식 있는 분위기를 만드는 사회자입니다.",
  "유쾌형": "자연스럽고 유쾌한 텐션으로 하객 반응을 살리는 사회자입니다.",
  "감성형": "따뜻하고 포근한 톤으로 예식 전체에 감동을 더하는 사회자입니다.",
  "아나운서형": "정확한 발성과 안정적인 톤으로, 어떤 예식장에서도 흔들림 없이 깔끔한 식순 진행을 보여주는 사회자입니다.",
};
              ...
              <div
                ...
                onClick={() => {
                  const profileMap: Record<string, string> = {
                    ...
                    "이상운": "/profile-sangwoon.html",
                    "손진욱": "/profile-sonjinwook.html",
                  };
