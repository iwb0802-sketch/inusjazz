...
2-4. 예시 - 답변 원문: "귀여운 인디언 보조개와 맑고 깨끗한 피부가 매력입니다." → script: "신랑님께서는 <answer>신부님의 사랑스러운 보조개와 맑은 미소</answer>를 가장 큰 매력으로 꼽아 주셨습니다."
2-5. 답변 문장을 그대로 인용해야 의미가 살아나는 짧은 표현(별명, 애칭, 한 줄 다짐 등)만 예외적으로 원문을 유지할 수 있습니다.
