...
- 답변지 내용은 원문 그대로 붙여 넣지 않고, 사회자가 하객 앞에서 소개하는 3인칭 존댓말로 다듬어 반영합니다. 다듬은 문장을 <answer>와 </answer>로 감쌉니다.
- 답변자의 1인칭 말투("~했어요", "저는", "제가")는 "신부님께서는 ~라고 이야기해 주셨습니다" 같은 사회자 화법으로 바꿉니다. 사실과 의미는 바꾸지 않고 문장만 다듬습니다.
- 다듬을 때 답변에 적힌 매력 포인트·키워드는 하나도 빠뜨리지 않습니다. 예: "보조개와 맑고 깨끗한 피부" → 두 가지 모두 그대로 살립니다. 요약·축약·의역으로 내용을 줄이지 않습니다.
